...
import com.benmohammad.hackio.taskdetail.TaskDetailResult.PopulateTaskResult.Failure
import com.benmohammad.hackio.taskdetail.TaskDetailViewState.UiNotification.*
...
class TaskDetailViewModel(
    ...
    private fun actionFromIntent(intent: TaskDetailIntent): TaskDetailAction {
        return when (intent) {
            ...
            is TaskDetailIntent.CompleteTaskIntent-> TaskDetailAction.ActivateTaskAction(intent.taskId)
        }
    }
